...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sortByBattleCount = QtWidgets.QPushButton(self.centralwidget)
        self.sortByBattleCount.setGeometry(QtCore.QRect(460, 50, 80, 31))
        self.sortByBattleCount.setObjectName("sortByBattleCount")
